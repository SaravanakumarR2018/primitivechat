...
class TestListFileAPI(unittest.TestCase):
    ...
    def test_list_files_from_invalid_customer_guid(self):
        logger.info(
            "Executing test_list_files_from_invalid_customer_guid: Testing list files with an invalid customer_guid")
    ...
    def test_list_files_two_files_uploaded(self):
        ...
        for filename, content, mime_type in files_to_upload:
            ...
            if upload_response.status_code == 200:
                ...
                logger.error(
                    f"Failed to upload file {filename}. Status code: {upload_response.status_code}. Expected: 200.")
    ...
    def test_list_files_three_files_uploaded(self):
        ...
        for filename, content, mime_type in files_to_upload:
            ...
            if upload_response.status_code == 200:
                ...
                logger.error(
                    f"Failed to retrieve file list. Status code: {upload_response.status_code}. Expected: 200.")
