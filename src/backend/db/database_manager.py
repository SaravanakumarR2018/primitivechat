...
class DatabaseManager:
    ...
    def insert_customer_file_status(self, customer_guid, filename, file_id):
        ...
        try:
            ...
            """
            session.execute(text(insert_common_query), {'customer_guid': customer_guid, 'filename': filename, 'file_id': file_id})
            ...
            VALUES (:customer_guid, :filename, :file_id,  'todo', NULL, 0, NULL, FALSE, NULL, 'todo', NULL);
            """
            session.execute(text(insert_customer_query), {'customer_guid': customer_guid, 'filename': filename, 'file_id': file_id})
            session.commit()
